...
public interface Calculator {
	...
	// 속성(필드, 멤버변수) : interface 에서는 묵시적으로 public static final => 상수
	public static final double PI = 3.14;
	static final int MAX_NUM = 100000;	// public 생략
	public int MIN_NUM = -100000;		// final static 생략
	int ZERO = 0;						// public final static 생략
	
	
	// 생성자
	
	// 메서드 : interface 에서는 묵시적으로 public abstract
	public abstract int plus(int num1, int num2);
	int minus(int num1, int num2);					// public abstract 생략
	public int multiple(int num1, int num2);		// abstract 생략
